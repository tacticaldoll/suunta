...
- [ ] 2.1 Merge the delta spec's MODIFIED requirement into
      `openspec/specs/quality-governance/spec.md`.
- [ ] 2.2 Remove the `govern-crate-readme-presence` change directory.
